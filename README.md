...
여러 엑셀/CSV 파일을 고치지 않고 문제만 표시합니다.
...
- 필수 단계가 아니라 파일 구조가 의심될 때 쓰는 점검 기능

### 2. 정리된 엑셀 새 파일 만들기

엑셀/CSV 파일 1개를 실제로 정리해서 새 결과 파일로 만듭니다.
...
1번은 "원본을 보며 어디가 문제인지 확인"이고, 2번은 "정리된 결과표를 만들어 사용"하는 기능입니다.
