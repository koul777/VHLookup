...
- 위 변경사항을 포함한 Windows 실행파일 ZIP을 다시 빌드해 Release에 배포했습니다.
...
현재 `2026-08-24 v1.4` 빌드 기준 SHA256은 아래와 같습니다.

```text
VHLookupLocal_v1.4.zip: 1EA703CC14D5B1FC49593DD27EE2065FB4F754607B22EB36A00A0E38297FD788
VHLookupLocal_v1.4.exe: 3AD92F760E8154A6A464E402966F664552F8685C1ACF6ED83735125B09CB63DF
```

v1.4 빌드 파일 크기는 zip `41,212,158 bytes`, 압축 해제 후 exe `43,971,430 bytes`입니다.
